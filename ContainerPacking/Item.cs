...
namespace ContainerPacking
{
    ...
    public class Item
    {
        ...
        public Item(int id, decimal dim1, decimal dim2, decimal dim3, int quantity, bool notRotatable = false, bool notPlaceUnder = false)
        {
            this.ID = id;
            this.Dim1 = dim1;
            this.Dim2 = dim2;
            ...
            this.notRotatable = notRotatable;
            this.notPlaceUnder = notPlaceUnder;
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this item has rotatable.
        /// </summary>
        [DataMember]
        public bool notRotatable { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this item has not place another item.
        /// </summary>
        [DataMember]
        public bool notPlaceUnder { get; set; }
